...
<head>
  ...
  <title> E-Inventaris | SMP N 5 Comal</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <a href="<?= base_url('Admin') ?>" class="brand-text font-weight-light"><b>E-Inventaris</b></a>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?= base_url('AdminLTE') ?>/dist/img/logo.png" class="img-circle elevation-4" alt="User Image">
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item <?= $menu == 'masterdata'? 'menu-open' : '' ?>">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?= base_url('Barangmasuk')?>" class="nav-link <?= $submenu == 'barangmasuk'? 'active' : '' ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Barang Masuk</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url('Rinci')?>" class="nav-link <?= $submenu == 'rinci'? 'active' : '' ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Barang Keluar</p>
                </a>
              </li>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2022 <a href="">E-Inventaris SMP Negeri 5 Comal</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
